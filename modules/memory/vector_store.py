"""JSON tabanlı vektör deposu – embedding, kayıt, benzerlik araması."""
import os
import json
import numpy as np
...
class VectorStore:
    ...
    def get_all_texts(self) -> list[str]:
        """Tüm kayıtlı metinleri döner (yedek)."""
